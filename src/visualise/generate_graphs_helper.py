...
def generate_transaction_types_bar_graph_per_period_helper(start_date: str, end_date: str,
                                                           bank_statement_df: DataFrame):
    """
    ...
    outgoing_transfers) one cluster per period.
        ...
        :param bank_statement_df: DataFrame of the bank statements
    """
...
def generate_balance_bar_graph_per_period_helper(start_date: str, end_date: str, bank_statement_df: DataFrame):
    """
...
def generate_balance_pie_graph_helper(start_date: str, end_date: str, bank_statement_df: DataFrame):
    """
    ...
    below the chart, colored red if negative.
        ...
        :param bank_statement_df: DataFrame of the bank statements
    """
    generate_balance_graph(get_categorise_statements(start_date, end_date, bank_statement_df), "pie")


def generate_balance_bar_graph_helper(start_date: str, end_date: str, bank_statement_df: DataFrame):
    """
    Income vs Expenses comparison, as a pie or bar chart. Net balance is shown
    below the chart, colored red if negative.
        ...
        :param bank_statement_df: DataFrame of the bank statements
    """
    generate_balance_graph(get_categorise_statements(start_date, end_date, bank_statement_df), "bar")


def generate_transaction_types_bar_graph_helper(start_date: str, end_date: str, bank_statement_df: DataFrame):
    """
    ...
    (Expenses, Income, Misc, Incoming/Outgoing Transfers).
        ...
        :param bank_statement_df: DataFrame of the bank statements
    """
    transaction_dict = get_transaction_types_dict(start_date, end_date, bank_statement_df)
    generate_transaction_types_bar_graph(transaction_dict)


def generate_grouped_bar_graph_per_period_helper(start_date: str, end_date: str, bank_statement_df: DataFrame,
...
if __name__ == "__main__":
    ...
    # generate_balance_bar_graph_per_period_helper(start_date, end_date, bank_statement_df)
    # generate_transaction_types_bar_graph_per_period_helper(start_date, end_date, bank_statement_df)
    # generate_transaction_types_bar_graph_helper(start_date, end_date, bank_statement_df)
    # generate_balance_pie_graph_helper(start_date, end_date, bank_statement_df)
    # generate_balance_bar_graph_helper(start_date, end_date, bank_statement_df)

    # generate_sub_category_line_graph_per_period_helper(start_date, end_date, bank_statement_df, ["AURELIE YOGACOACHING","PAYROLL DEPOSIT SERVICE DE GARDE", "CHEQUE DEPOSIT"])

    # sliced_statements = get_monthly_statements(start_date, end_date, bank_statement_df)
    # income = generate_income_sub_categories(sliced_statements)
    # generate_grouped_bar_graph_per_period_helper(start_date, end_date, bank_statement_df, income)
    #
    sliced_statements = get_monthly_statements(start_date, end_date, bank_statement_df)
    ...
    generate_grouped_bar_graph_per_period_helper(start_date, end_date, bank_statement_df, expenses, "Category")
