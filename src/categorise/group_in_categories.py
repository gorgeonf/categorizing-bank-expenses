...
INCOME = {"EI CANADA", "PAYROLL DEPOSIT", "SERVICE DE GARDE LES COPAINS", "MOBILE CHEQUE DEPOSIT", "PAYROLL DEPOSIT TERADICI CORPOR" }
...
YOGA_AND_COACHING = {"YOGACOACHING", "LUCYSTJOHN", "SYSTEME.IO", "ZENSURANCE.COM", "NANCY GIRARD", "CYNTHIA DOMINGUE",
                     "BÉATRICE LAROUCHE", "MAXINE BULLOCH"}

COFFEES = {"49TH PARALLE",
           "MATCHSTICK",
           "SQ *CHEZ NOUS B",
           "BLENZ ON DENMAN",
           "SQ *ANALOG COFF",
...
KEYWORD_SUB_CATEGORY_OVERRIDE = {
    ...
    "LUCYSTJOHN": "LUCYSTJOHN YOGA TEACHER TRAINING",
